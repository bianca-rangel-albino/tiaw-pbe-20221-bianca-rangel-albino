...
Para montar a interface do site, foi feito o levantamento do mapa conceitual, o mapa do site, o wireframe e o task flow, para conseguir estabelecer agilidade, acessibilidade e usabilidade no projeto. 
